...
const tabs = document.querySelectorAll('[data-target]'),
      ...
      function portfolioItemDetails(portfolioItem){
        ...
        document.querySelector(".portfolio__popup-subtitle span").innerHTML = portfolioItem.querySelector('.work__category').innerHTML;
      ...
      function toggleCertPopup(){
        document.querySelector('.cert__outer').classList.toggle('open__cert');
      }
